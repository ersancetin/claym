...
export class ActuarialEngine {
    ...
    /**
     * Emeklilik yaşı alanının varsayılan değeri (pasif dönem başlangıcı). Yargıtay kararlarında
     * genellikle 60 esas alındığı görülür; kullanıcı dosyaya göre farklı bir yaş girebilir.
     */
